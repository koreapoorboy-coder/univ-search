...
const checks = [
  ...
  [worker.includes("required: ['reportTitle', 'report']"), "complete-report schema is not required"],
  [worker.includes("report: { type: 'string', minLength: 1800 }"), "report body schema minimum is missing"],
