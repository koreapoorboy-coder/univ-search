...
// P9: 과목 묶음 — 실제 파일.
{
  ...
  // 2026-09-26: 2022 개정 수학 선택 과목 가운데 셋을 더 넣었다(53 → 56). 순수 수학과 달리 이
  // 과목들은 다른 학문에 기댄다 — 경제 수학은 경제학, 인공지능 수학은 컴퓨터학, 실용 통계는 통계학에
  // 학생이 읽을 만한 한글 논문이 있다. 수학과 문화·수학과제 탐구는 분야를 하나로 못 묶어 만들지 않았다.
  check(subjects.length === 56, "P9 묶음을 만들 과목 56개", String(subjects.length));
