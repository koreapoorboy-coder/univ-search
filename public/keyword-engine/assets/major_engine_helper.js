...
(function(){
  ...
  const MAJOR_COPY_OVERRIDES = {
    ...
    '건설환경공학과': {
      ...
      card: '도시 기반시설을 설계·시공·관리하면서 수질·대기·폐기물 같은 환경 문제까지 함께 다루는 학과입니다.',
      fit: '인프라를 단순 구조물이 아니라 환경과 연결된 시스템으로 보고 기술적으로 해결하고 싶은 학생에게 잘 맞습니다.',
      intro: '건설환경공학과는 도로·교량·상하수도 같은 사회기반시설의 설계와 시공, 유지관리를 배우고 수질·대기·폐기물 같은 환경 문제를 함께 다루며 지속가능한 도시 시스템을 고민하는 학과입니다.',
      subjects: ['물리학', '화학', '지구과학', '미적분', '정보'],
    ...
    '토목환경공학과': {
      ...
      card: '도로·교량·하천·상하수도 같은 사회기반시설을 구조와 환경 관리 관점에서 함께 배우는 학과입니다.',
      fit: '구조물 안전성과 수자원·환경 관리 문제를 같이 보고 싶은 학생에게 잘 맞습니다.',
      intro: '토목환경공학과는 도로·교량·하천·상하수도 같은 토목 구조물의 설계와 해석을 배우고 수질·대기·자원 관리까지 함께 다루며 사회기반시설과 환경의 균형을 이해하는 학과입니다.',
      subjects: ['물리학', '화학', '지구과학', '미적분', '정보'],
    ...
    '지구환경과학과': {
      ...
      card: '기후·대기·지질·수문 같은 지구 시스템의 변화를 관측 자료와 데이터로 분석하는 학과입니다.',
      fit: '기후 변화와 자연환경 문제를 데이터와 과학 모델로 해석해 보고 싶은 학생에게 잘 맞습니다.',
    ...
    '주거환경학과': {
      ...
      subjects: ['가정', '미술', '통합사회', '정보', '생명과학'],
      topics: ['세대별 주거환경 요구 차이와 공간 설계 비교', '실내 환경과 생활 습관의 관계 분석', '안전·편의를 반영한 생활 공간 개선 방향 탐구'],
      group_label: '주거·공간 설계',
      compare: ['도시공학과','건설환경공학과','토목환경공학과']
    },
    '도시공학과': {
      track_category: '도시/교통/인프라',
      card: '도시 공간과 주거·교통·환경·인프라를 큰 구조에서 종합적으로 계획하는 학과입니다.',
      ...
      subjects: ['세계시민과 지리', '통합사회', '미적분', '정보', '물리학'],
      topics: ['도시계획이 생활환경과 이동 방식에 미치는 영향 분석', '주거·교통·환경 요소를 통합한 도시 설계 비교', '재개발과 지역 공동체 변화의 관계 탐구'],
      group_label: '도시계획·인프라',
      compare: ['주거환경학과','건설환경공학과','토목환경공학과']
    }
  };
