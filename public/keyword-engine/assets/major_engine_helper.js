...
(function(){
  ...
  const MAJOR_COPY_OVERRIDES = {
    ...
    '건설환경공학과': {
      card: '도로·교량·상하수도 같은 도시 인프라와 수질·대기 등 환경 문제를 함께 다루는 공학 계열 학과입니다.',
      fit: '도시 기반시설과 환경 관리 문제를 기술적으로 연결해 해결하고 싶은 학생에게 잘 맞습니다.',
      intro: '건설환경공학과는 도로·교량·상하수도 같은 사회기반시설을 설계·관리하고 수질·대기·폐기물 같은 환경 문제를 함께 다루며 지속가능한 도시 시스템을 배우는 학과입니다.',
      subjects: ['물리학', '화학', '지구과학', '미적분', '통합과학1'],
      topics: ['건설 공정이 환경에 미치는 영향 분석', '도시 인프라와 환경 관리의 관계 탐구', '지속가능한 건설 기술 적용 사례 비교'],
      group_label: '도시·인프라',
      compare: ['토목환경공학과','도시공학과','지구환경과학과']
    },
    '토목환경공학과': {
      card: '도로·교량·하천·상하수도 같은 사회기반시설과 환경 관리를 함께 다루는 학과입니다.',
      fit: '사회기반시설과 수질·대기 같은 환경 관리 문제를 함께 보고 싶은 학생에게 잘 맞습니다.',
      intro: '토목환경공학과는 도로·교량·하천·상하수도 같은 토목 구조물과 수질·대기·자원 관리 문제를 함께 배우며 인프라와 환경을 통합적으로 이해하는 학과입니다.',
      subjects: ['물리학', '화학', '지구과학', '미적분'],
      topics: ['토목 구조와 환경 관리 기준의 관계 분석', '도시 인프라와 수질 관리 체계 비교', '지속가능한 토목 기술 사례 탐구'],
      group_label: '도시·인프라',
      compare: ['건설환경공학과','도시공학과','지구환경과학과']
    },
    '지구환경과학과': {
      card: '기후·대기·지질·수문 같은 지구 시스템의 변화를 관측 데이터로 분석하는 학과입니다.',
      fit: '자연환경 변화와 기후 문제를 과학적 자료로 해석하고 싶은 학생에게 잘 맞습니다.',
      intro: '지구환경과학과는 기후, 대기, 지질, 수문 등 지구 시스템의 변화를 관측 자료와 과학적 모델로 분석하며 환경 변화의 원인과 결과를 통합적으로 이해하는 학과입니다.',
      subjects: ['지구과학', '생명과학', '화학', '수학', '정보'],
      topics: ['지구 시스템의 순환 구조와 환경 변화의 관계 분석', '인간 활동이 대기·해양 환경에 미치는 영향 탐구', '지질·기후·생태 데이터를 연결한 환경 문제 해석'],
      group_label: '환경 관련 추천',
      compare: ['건설환경공학과','토목환경공학과','도시공학과']
    },
    '주거환경학과': {
      card: '주거 공간, 실내 환경, 생활 동선과 안전·편의를 사람 중심으로 설계하는 학과입니다.',
      fit: '사람이 살아가는 공간을 더 안전하고 편리하게 바꾸는 데 관심 있는 학생에게 잘 맞습니다.',
      intro: '주거환경학과는 주거 공간, 실내 환경, 생활 동선, 주거문화 등을 바탕으로 사람이 살아가는 공간을 설계하고 삶의 질을 높이는 환경을 분석하는 학과입니다.',
      subjects: ['미술', '가정', '통합사회', '정보', '생명과학'],
      topics: ['주거 공간 설계가 생활 습관에 미치는 영향 분석', '세대별 주거환경 요구 차이 비교', '안전과 편의를 반영한 생활 공간 개선 방향 탐구'],
      group_label: '공간·주거 환경',
      compare: ['도시공학과','건설환경공학과','지구환경과학과']
    },
    '도시공학과': {
      card: '도시 공간과 주거·교통·환경·인프라를 종합적으로 계획하는 학과입니다.',
      fit: '도시 문제를 큰 구조로 보고 생활환경을 설계·기획하는 데 관심 있는 학생에게 잘 맞습니다.',
      intro: '도시공학과는 주거, 교통, 인프라, 환경, 개발 계획을 통합적으로 다루며 사람이 살아가는 도시를 설계하고 운영하는 방식을 배우는 학과입니다.',
