...
(function(){
  ...
  const MAJOR_COPY_OVERRIDES = {
    ...
    '의공학과': {
      card: '의료기기, 의료영상, 생체신호 기술을 공학적으로 설계하고 분석하는 학과입니다.',
      fit: '공학을 의료기기와 생체신호 해석에 연결해 보고 싶은 학생에게 잘 맞습니다.',
      intro: '의공학과는 의료기기, 바이오센서, 의료영상, 생체신호 처리 기술을 바탕으로 의료 현장의 문제를 공학적으로 해결하는 학과입니다.',
    ...
    '제약공학과': {
      ...
      compare_profiles: [
        ...
        { display_name: '의공학과', track_category: '의료기기/생체신호/공학융합', focus: '의료기기와 생체신호를 공학적으로 분석하고 설계하는 학과입니다.', hint: '공학을 의료 현장 장비와 측정 기술에 연결하고 싶은 학생에게 잘 맞습니다.' }
      ]
    },
    '생명공학과': {
