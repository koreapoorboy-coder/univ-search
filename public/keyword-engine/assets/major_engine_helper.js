...
window.__MAJOR_ENGINE_HELPER_VERSION__ = "v0.7.2-major-search-integrated-bundle";
...
(function(){
  ...
  function getQueryAllowedGroupIds(rawInput){
    ...
    if (input.includes('간호') || input.includes('방사선') || input.includes('임상병리') || input.includes('보건관리')) return new Set(['clinical_health']);
    ...
    if (input.includes('행정') || input.includes('공공') || input.includes('경찰') || input.includes('법') || input.includes('정치') || input.includes('외교') || input.includes('군사')) return new Set(['law_public']);
  ...
  const MAJOR_COPY_OVERRIDES = {
    ...
    '안경광학과': {
      card: '시각 기능 평가, 렌즈·굴절·광학 기초, 검사 기반 의료 보조 성격이 강한 학과입니다.',
      fit: '시력 검사, 렌즈, 광학 원리, 정밀 측정 기반 의료기술에 관심 있는 학생에게 잘 맞습니다.',
      intro: '안경광학과는 시각 기능을 평가하고 안경·콘택트렌즈를 처방·가공하며 시력 교정과 시기능 관리에 필요한 광학 원리와 검안 기술을 배우는 학과입니다.',
      subjects: ['물리학', '생명과학', '통합과학1', '보건', '공통수학1'],
      topics: ['렌즈 굴절 원리가 시력 교정에 미치는 영향 탐구', '시력 검사 과정에서 정밀 측정이 중요한 이유 분석', '생활 습관과 시기능 변화의 관계 비교'],
      group_label: '보건·임상',
      compare: ['의공학과','방사선학과','임상병리학과']
    },
    '경찰행정학과': {
      card: '치안, 수사, 범죄 예방, 법질서 유지와 공공 안전 체계를 중심으로 배우는 학과입니다.',
      fit: '법질서, 범죄 문제, 공공 안전과 현장 대응을 함께 이해하고 싶은 학생에게 잘 맞습니다.',
      intro: '경찰행정학과는 범죄 예방과 수사, 치안 행정, 법질서 유지, 지역사회 안전 체계를 배우며 경찰 조직과 공공 안전의 실제 운영 방식을 이해하는 학과입니다.',
      subjects: ['통합사회', '정치', '공통국어', '경제', '영어'],
      topics: ['범죄 유형별 예방 정책 비교', '지역 치안 서비스와 주민 체감 안전도의 관계 분석', '경찰 조직의 역할과 공공 신뢰 형성 요인 탐구'],
      group_label: '행정·정책·법',
      compare: ['행정학과','법학과','군사학과']
    },
    '행정학과': {
      card: '정책 설계와 행정 제도, 공공 조직 운영을 중심으로 배우는 학과입니다.',
      fit: '사회 문제를 제도와 정책으로 해결하는 과정에 관심 있는 학생에게 잘 맞습니다.',
      intro: '행정학과는 공공 정책과 행정 제도, 정부 조직 운영, 예산과 공공서비스 전달 체계를 배우며 사회 문제를 제도적으로 해결하는 방법을 탐구하는 학과입니다.',
      subjects: ['통합사회', '정치', '경제', '공통국어', '영어'],
      topics: ['행정 서비스 품질이 시민 만족도에 미치는 영향 분석', '정책 집행 과정에서 발생하는 문제점 비교', '공공기관 운영 구조와 책임성 확보 방안 탐구'],
      group_label: '행정·정책·법',
      compare: ['경찰행정학과','정치외교학과','공공인재학부']
    },
    '정치외교학과': {
      card: '정치 제도와 국제관계, 외교 전략을 함께 다루는 학과입니다.',
      fit: '정치 제도와 국제 이슈를 연결해서 해석하고 싶은 학생에게 잘 맞습니다.',
      intro: '정치외교학과는 국내 정치 제도와 국제관계, 외교 전략, 안보와 국가 간 협상 구조를 배우며 정치 현상을 폭넓게 해석하는 학과입니다.',
      subjects: ['통합사회', '정치', '영어', '공통국어', '세계사'],
      topics: ['국가 간 외교 갈등 사례 비교 분석', '정치 제도가 사회 갈등 조정에 미치는 영향 탐구', '외교 전략과 국가 이익의 관계 이해'],
      group_label: '행정·정책·법',
      compare: ['행정학과','법학과','국제학부']
    },
    '법학과': {
      card: '법률 해석과 판례, 권리와 의무, 분쟁 해결 원리를 중심으로 배우는 학과입니다.',
      fit: '규칙과 기준, 권리 보호와 사회 질서를 논리적으로 해석하는 데 관심 있는 학생에게 잘 맞습니다.',
      intro: '법학과는 헌법, 민법, 형법, 행정법 등 법 체계를 바탕으로 권리와 의무, 분쟁 해결, 법질서 유지 원리를 배우는 학과입니다.',
      subjects: ['통합사회', '정치', '공통국어', '경제', '영어'],
      topics: ['판례 비교를 통해 보는 법 적용 기준 분석', '권리와 의무 충돌 사례의 해결 방식 탐구', '법 제도가 사회 질서 유지에 미치는 영향 이해'],
      group_label: '행정·정책·법',
      compare: ['경찰행정학과','행정학과','정치외교학과']
    },
    '공공인재학부': {
      card: '공공 조직과 정책, 리더십과 행정 문제 해결을 종합적으로 배우는 학과입니다.',
      fit: '공공 부문 진로를 넓게 탐색하면서 정책과 조직 운영을 함께 보고 싶은 학생에게 잘 맞습니다.',
      intro: '공공인재학부는 행정, 정책, 공공 조직 운영, 리더십과 문제 해결 역량을 바탕으로 다양한 공공 부문 진로를 준비하는 학과입니다.',
      subjects: ['통합사회', '정치', '공통국어', '경제', '영어'],
      topics: ['공공기관 역할 비교와 진로 탐색', '정책 문제 해결 과정에서 필요한 리더십 요소 분석', '공공 조직 운영과 사회 신뢰의 관계 탐구'],
      group_label: '행정·정책·법',
      compare: ['행정학과','경찰행정학과','군사학과']
    },
    '군사학과': {
      card: '안보와 국방, 전략과 조직 운영, 위기 대응을 중심으로 배우는 학과입니다.',
      fit: '국가 안보와 전략, 조직 운영과 현장 판단을 함께 이해하고 싶은 학생에게 잘 맞습니다.',
      intro: '군사학과는 국가 안보와 국방 전략, 군 조직 운영, 위기 대응, 리더십과 지휘 체계를 배우며 안전과 안보 문제를 종합적으로 이해하는 학과입니다.',
      subjects: ['통합사회', '정치', '세계사', '체육', '공통국어'],
      topics: ['국가 안보 전략과 국제 정세의 관계 분석', '군 조직의 리더십과 지휘 체계 비교', '위기 상황 대응 구조와 공공 안전 체계 탐구'],
      group_label: '행정·정책·법',
      compare: ['경찰행정학과','행정학과','정치외교학과']
    },
    '보건관리학과': {
  ...
  function buildHeuristicKeywords(displayName, trackCategory){
    ...
    const rules = [
      ...
      [/안경광학|간호|의예|약학|치의|한의|수의|보건관리|보건|방사선|물리치료|임상병리|작업치료|재활상담|치위생|치기공|응급구조|언어치료/, ['건강 데이터','생체 반응','질병 이해','의료 사례','문제 해결']],
  ...
  function classifyCandidateGroup(row, rawInput){
    ...
    const rules = [
      ...
      { id:'clinical_health', label:'환자 진료·검사 쪽', desc:'환자 돌봄, 검사, 영상, 보건관리처럼 의료 현장과 가까운 학과입니다.', test: /(안경광학|검안|광학|보건관리|간호|방사선|임상병리|치위생|치기공|응급구조|의예|약학|한의|수의|보건)/ },
  ...
  function buildStudentDescription(profile, group){
    ...
    const name = String(profile?.display_name || '');
    const rules = [
      [/안경광학/, '시각 기능 평가, 렌즈·굴절·광학 기초, 검사 기반 의료 보조 성격이 강한 학과입니다.'],
      ...
      [/경찰행정/, '치안, 수사, 범죄 예방, 법질서 유지와 공공 안전 체계를 중심으로 배우는 학과입니다.'],
      [/행정학/, '정책 설계와 행정 제도, 공공 조직 운영을 중심으로 배우는 학과입니다.'],
      [/정치외교/, '정치 제도와 국제관계, 외교 전략을 함께 다루는 학과입니다.'],
      [/법학/, '법률 해석과 판례, 권리와 의무, 분쟁 해결 원리를 중심으로 배우는 학과입니다.'],
      [/공공인재/, '공공 조직과 정책, 리더십과 행정 문제 해결을 종합적으로 배우는 학과입니다.'],
      [/군사학/, '안보와 국방, 전략과 조직 운영, 위기 대응을 중심으로 배우는 학과입니다.'],
  ...
  function buildStudentFit(profile, group){
    ...
    const name = String(profile?.display_name || '');
    const rules = [
      [/안경광학/, '시력 검사, 렌즈, 광학 원리, 정밀 측정 기반 의료기술에 관심 있는 학생에게 잘 맞습니다.'],
      ...
      [/경찰행정/, '법질서, 범죄 문제, 공공 안전과 현장 대응을 함께 이해하고 싶은 학생에게 잘 맞습니다.'],
      [/행정학/, '사회 문제를 제도와 정책으로 해결하는 과정에 관심 있는 학생에게 잘 맞습니다.'],
      [/정치외교/, '정치 제도와 국제 이슈를 연결해서 해석하고 싶은 학생에게 잘 맞습니다.'],
      [/법학/, '규칙과 기준, 권리 보호와 사회 질서를 논리적으로 해석하는 데 관심 있는 학생에게 잘 맞습니다.'],
      [/공공인재/, '공공 부문 진로를 넓게 탐색하면서 정책과 조직 운영을 함께 보고 싶은 학생에게 잘 맞습니다.'],
      [/군사학/, '국가 안보와 전략, 조직 운영과 현장 판단을 함께 이해하고 싶은 학생에게 잘 맞습니다.'],
