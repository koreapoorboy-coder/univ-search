...
(function(){
  ...
  const MAJOR_COPY_OVERRIDES = {
    ...
    '토목환경공학과': {
      ...
      intro: '토목환경공학과는 도로·교량·하천·상하수도 같은 토목 구조물의 설계와 해석을 배우고, 수자원·수질·환경 관리까지 함께 다루며 사회기반시설과 자연환경의 균형을 이해하는 학과입니다.',
    ...
    '지구환경과학과': {
      ...
      fit: '기후 변화와 자연환경 문제를 관측 자료, 지도, 과학 모델로 해석해 보고 싶은 학생에게 잘 맞습니다.',
    ...
    '도시공학과': {
      ...
      subjects: ['세계시민과 지리', '통합사회', '정보', '미적분', '물리학'],
