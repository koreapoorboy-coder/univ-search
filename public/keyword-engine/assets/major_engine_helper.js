...
(function(){
  ...
  async function loadAll(){
    try {
      ...
      backfillPriorityMajorsForSearch(['연극영화과','영화영상학과','공연예술학과','방송영상학과','애니메이션학과','실용음악과','체육학과','스포츠과학과','스포츠산업학과','사회체육학과','레저스포츠학과','스포츠의학과','행정학과','정치외교학과','법학과','경찰행정학과','공공인재학부','사회학과','관광경영학과','호텔경영학과','항공서비스학과','항공운항학과','외식경영학과','MICE산업학과','식품영양학과','식품공학과','동물자원학과','원예생명과학과','산림자원학과','농업경제학과','항공기계공학과','항공정비학과','조선해양공학과','해양공학과','교통공학과','원자력공학과','소방방재학과']);
