...
(function(global){
  ...
  const VERSION = "mini-worker-generate-bridge-v54-result-lens-precision";
  ...
  function buildStudentReportFromPayload(req, rawData){
    ...
    return {
      ...
      diagnostics: {
        ...
        view,
        line,
        productMode: "major_concept_book_bridge_blueprint_v54_result_lens_precision",
        focusQuestion,
  ...
  function bindGenerateButton(){
    ...
    btn.dataset.miniWorkerV32Bound = "v54";
