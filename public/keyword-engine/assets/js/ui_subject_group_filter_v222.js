...
(function(){
  ...
  const SUBJECT_CATALOG = [
    ...
    // 2022 개정 사회·도덕 선택 과목 19개(2026-09-26).
    { value:"경제", text:"경제", group:"사회" },
    { value:"국제 관계의 이해", text:"국제 관계의 이해", group:"사회" },
    { value:"금융과 경제생활", text:"금융과 경제생활", group:"사회" },
    { value:"기후변화와 지속가능한 세계", text:"기후변화와 지속가능한 세계", group:"사회" },
    { value:"도시의 미래 탐구", text:"도시의 미래 탐구", group:"사회" },
    { value:"동아시아 역사 기행", text:"동아시아 역사 기행", group:"사회" },
    { value:"법과 사회", text:"법과 사회", group:"사회" },
    { value:"사회문제 탐구", text:"사회문제 탐구", group:"사회" },
    { value:"사회와 문화", text:"사회와 문화", group:"사회" },
    { value:"세계사", text:"세계사", group:"사회" },
    { value:"세계시민과 지리", text:"세계시민과 지리", group:"사회" },
    { value:"여행지리", text:"여행지리", group:"사회" },
    { value:"역사로 탐구하는 현대 세계", text:"역사로 탐구하는 현대 세계", group:"사회" },
    { value:"윤리문제 탐구", text:"윤리문제 탐구", group:"사회" },
    { value:"윤리와 사상", text:"윤리와 사상", group:"사회" },
    { value:"인문학과 윤리", text:"인문학과 윤리", group:"사회" },
    { value:"정치", text:"정치", group:"사회" },
    { value:"한국지리 탐구", text:"한국지리 탐구", group:"사회" },
    { value:"현대사회와 윤리", text:"현대사회와 윤리", group:"사회" },
    ...
    { value:"물리", text:"물리학", group:"과학" },
    { value:"화학", text:"화학", group:"과학" },
    { value:"화학 반응의 세계", text:"화학 반응의 세계", group:"과학" },
    { value:"생명과학", text:"생명과학", group:"과학" },
    // 2026-09-26: 다시 넣었다. 2022 개정 교육과정(별책9)과 미래엔 교사용 교과서로 단원 6개를 만들고,
    // 논문 묶음(2,253편)과 서울대 연구 글(23편)까지 붙였다. 전에는 이름만 있고 속이 비어 있었다.
