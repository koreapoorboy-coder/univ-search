...
export function titleRules(kind = COLLECTION.MEASUREMENT, stage = STAGE.COMPLETE) {
  ...
  return [
    ...
    '- 쉼표로 두 토막을 잇지 않는다. "A를 측정, B를 확인" 같은 형태는 제목이 아니라 요약 문장이다. 선생님은 생활기록부에 "\'제목\'을 수행하여 ~"처럼 쓰기 때문에, 제목 안에 문장이 들어 있으면 문장이 겹쳐 읽기 어려워진다.',
    ...
    ...(second
      ? ['- 이번에는 학생의 자료가 있다. 결과정리를 보고 조건에 따라 값이 한 방향으로 뚜렷하게 움직였으면, 알아낸 방향까지 제목에 담는다. 무엇을 했는지에 더해 무엇을 알아냈는지가 보이는 제목이 생활기록부에서 훨씬 강하다.',
        ...
        '  나쁨: "진자 충돌 6조건 3회 측정, 각도가 클수록 보존도 증가 확인" — 쉼표 뒤가 문장이라 제목이 아니다.',
        '  나쁨: "염화농도·온도 6조건 구리 착이온 녹색 성분 3회 측정 비교" — 값이 뚜렷하게 올라갔는데 알아낸 것이 빠졌다.',
        '  좋음: "질량비·각도 6조건 진자 충돌에서 각도에 따른 운동량 보존도 증가 측정"',
        '  좋음: "염화농도·온도 6조건에서 농도와 온도에 따른 구리 착이온 녹색 성분 증가 측정"',
        '  좋음: "고령화 2개 군 4개 연도 심정지 출동 비율의 연도별 증가 비교"',
        '  좋음: "관광 안내서·학술 논문 5편의 발행 주체별 인물 서술 차이 비교"',
