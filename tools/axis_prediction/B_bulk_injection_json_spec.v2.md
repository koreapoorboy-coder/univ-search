...
| `question_no` | ✅ | ★**필수화**. 단 **매칭키 아님**(시험지 재구성 가능·번호배제)·content_hash 미포함. ★**저장함**(v3.2, 검수 2026-08-14) — `bulk_batch_id`와 조합해 원본 학습지 대조. 식별키는 id. failed 보고·pending 후처리·감사 추적용. |
...
| 27 | ★**question_no 저장**(v3.2 컬럼·참조·원본대조) — 검수 실측 발견 | ✅ | §3·schema v3.2 |
| — | **누락: 없음** (27항 + 지적 A·B 반영). | — | — |
