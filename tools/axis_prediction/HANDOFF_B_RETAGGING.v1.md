...
- **📊 20단원 완결 집계**(전 리플렉션 스캔): 총 **2722문항** / 관측 **321종**(=축매핑풀 321, 13맵). **17축 관측분포**(item-level 5218건): C3·1153>C1·1083>C2·679>C4·528>B3·328>D1·322>D3·290>D2·267>B2·200>B1·125>A3·100>E3·44>B4·36>A2·35>E1·28. **미등장 = A1·E2**(2축). **tier**: confident 223·**boundary 154**. 최다 경계쌍 C1↔C3·17/C3↔C2·12/C3↔C1·11/C2↔C3·10/C4↔C1·9/C4↔C3·8/C4↔D1·6/C1↔C2·6(C계 상호경계가 대부분 → 경계 재검토 시 C1/C3·C2/C3·C4/C1 묶어 판례화).
