...
const GROUP = {
  ...
  // 2026-09-21: 단원 사전이 아예 없던 다섯 과목. 사전을 만들었으니 논문 묶음도 같이 만든다 —
  // 단원만 더하면 재료가 없어 오히려 나빠진다(과학탐구실험에서 겪었다).
  "인공지능 기초": "정보", "데이터 과학": "정보", "융합과학 탐구": "과학", "과학과제 연구": "과학",
  "화학 반응의 세계": "과학",
  // 2026-09-26: 「생물의 유전」도 이름만 있고 단원 사전이 없던 과목이다(2022 개정 진로 선택).
  // 교육과정(별책9)과 미래엔 교사용 교과서로 단원 6개를 만들면서 논문 묶음도 같이 만든다.
  "생물의 유전": "과학",
  // 2026-09-26: 2022 개정 국어 선택 과목 7개. 교육과정 별책5 로 단원을 만들면서 묶음도 같이 만든다.
  "문학": "국어",
  "매체 의사소통": "국어",
  "화법과 언어": "국어",
  "독서와 작문": "국어",
  ...
  "독서 토론과 글쓰기": "국어",
  "문학과 영상": "국어",
  // 2026-09-26: 2022 개정 수학 선택 과목 5개(별책8). 순수 수학과 달리 이 과목들은 다른 학문에 기댄다 —
  // 경제 수학은 경제학, 인공지능 수학은 컴퓨터학, 실용 통계는 통계학에 학생이 읽을 만한 한글 논문이 있다.
  // 수학과 문화·수학과제 탐구는 분야를 하나로 못 묶어 논문 묶음을 만들지 않고 연구 글만 붙인다.
  "경제 수학": "수학", "인공지능 수학": "수학", "실용 통계": "수학",
  "수학과 문화": "수학", "수학과제 탐구": "수학",
  // 2026-09-26: 2022 개정 사회·도덕 선택 과목 19개. 교육과정 별책6·7 로 단원을 만들면서 묶음도 같이 만든다.
  // 한국사가 쓰는 「사회·역사·윤리」 낱말 묶음을 역사·윤리 과목이 함께 쓴다.
  "현대사회와 윤리": "사회·역사·윤리",
  "윤리와 사상": "사회·역사·윤리",
  "인문학과 윤리": "사회·역사·윤리",
  "윤리문제 탐구": "사회·역사·윤리",
