...
const AREA = {
  ...
  // 2026-09-26: 2022 개정 수학 선택 과목 5개. 영역 이름과 번호는 교육과정 별책8에 적힌 그대로다.
  // 이 과목들은 영역 하나가 단원 하나다 — 영역이 내용으로 갈라져 있어 그대로 쓸 수 있다.
  '경제 수학': { '01': '수와 경제', '02': '함수와 경제', '03': '행렬과 경제', '04': '미분과 경제' },
  '인공지능 수학': { '01': '인공지능과 빅데이터', '02': '텍스트 데이터 처리', '03': '이미지 데이터 처리', '04': '예측과 최적화', '05': '인공지능과 수학 탐구' },
  '수학과 문화': { '01': '예술과 수학', '02': '생활과 수학', '03': '사회와 수학', '04': '환경과 수학' },
  '실용 통계': { '01': '통계와 통계적 문제', '02': '자료의 수집과 정리', '03': '자료의 분석', '04': '통계적 탐구' },
  '수학과제 탐구': { '01': '과제 탐구의 이해', '02': '과제 탐구의 방법과 절차', '03': '과제 탐구의 실행 및 평가' },
};
...
const SUBJECT_OF = [
  ...
  [/^12영[ⅠI1]$/, '영어'],
  [/^12영[ⅡII2]$/, '영어'],
  // 2026-09-26: 「문학」은 이제 화면에 있는 과목이다(교육과정 별책5로 단원 8개를 만들었다).
  // 그때까지는 공통국어1 의 문학 단원으로 보냈는데, 그러면 문학을 고른 학생은 코드를 읽어도 단원이 안 나왔다.
  // 두 과목을 적는다. 문학을 고른 학생도, 공통국어1 을 고르고 문학 코드가 적힌 안내문을 낸 학생도
  // 단원이 나와야 한다(문학 과목이 화면에 없던 동안에는 공통국어1 로 고를 수밖에 없었다).
  [/^12문학$/, ['문학', '공통국어1']],
  [/^12유전$/, '생물의 유전'],
  // 2026-09-26: 2022 개정 수학 선택 과목 5개(별책8).
  [/^12경수$/, '경제 수학'],
  [/^12인수$/, '인공지능 수학'],
  [/^12수문$/, '수학과 문화'],
  [/^12실통$/, '실용 통계'],
...
const MAP = {
  ...
  // 2026-09-26: 「문학」 과목은 통째로 한 영역이다(코드가 모두 01). 단원 8개를 다 놓고
  // 과제 글과 가장 많이 겹치는 것을 고른다(unit_from_standard_v1.mjs 의 overlap).
  '문학': {
    문학: ['작품 비평과 주체적 감상', '시 갈래와 서정적 표현', '소설·극 갈래와 이야기 구성', '수필과 성찰적 글쓰기', '작품 재구성과 창작', '한국 문학의 역사와 사회', '매체로 구현된 문학', '독서 활동과 문학의 생활화'],
  },
  // 2026-09-26: 수학 선택 과목은 영역 하나가 단원 하나다.
  '경제 수학': { '수와 경제': ['수와 경제'], '함수와 경제': ['함수와 경제'], '행렬과 경제': ['행렬과 경제'], '미분과 경제': ['미분과 경제'] },
  '인공지능 수학': { '인공지능과 빅데이터': ['인공지능과 빅데이터'], '텍스트 데이터 처리': ['텍스트 데이터 처리'], '이미지 데이터 처리': ['이미지 데이터 처리'], '예측과 최적화': ['예측과 최적화'], '인공지능과 수학 탐구': ['인공지능과 수학 탐구'] },
  '수학과 문화': { '예술과 수학': ['예술과 수학'], '생활과 수학': ['생활과 수학'], '사회와 수학': ['사회와 수학'], '환경과 수학': ['환경과 수학'] },
  '실용 통계': { '통계와 통계적 문제': ['통계와 통계적 문제'], '자료의 수집과 정리': ['자료의 수집과 정리'], '자료의 분석': ['자료의 분석'], '통계적 탐구': ['통계적 탐구'] },
  '수학과제 탐구': { '과제 탐구의 이해': ['과제 탐구의 이해'], '과제 탐구의 방법과 절차': ['과제 탐구의 방법과 절차'], '과제 탐구의 실행 및 평가': ['과제 탐구의 실행 및 평가'] },
  공통국어2: {
