...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v6.json (공통 15 C-* + 단원팩 D-*: EL_AELF·PS·GE·CA2_M2D·MM_CMM·PF_M1S1·EI_CMEI·SQ_ASQ)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v6.json'),
