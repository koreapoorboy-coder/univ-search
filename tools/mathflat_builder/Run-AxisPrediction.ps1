...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v42.json (공통 15 C-* + 단원팩 D-*: …·PN_CG·PN_PG)  v39: PN_M1LC 29(함수의 극한과 연속 고2, B1 50.7% 역대 최초 진짜 지배축) · v40: PN_SG 29(입체도형 중1, 지배축 없음·C1 봉쇄 70.5%) · v41: PN_CG 29(좌표와 그래프 중1, 지배축 C2 51.2%·C-07 규율 신설) · v42: PN_PG 28(평면도형 중1, 지배축 없음·C1 봉쇄 84% 역대최대, C-10 규율 신설, 평균축 2.02 B안)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v42.json'),
