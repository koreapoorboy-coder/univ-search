...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v30.json (공통 15 C-* + 단원팩 D-*: …·SR_RC·NS_NE)  v29: SR_RC 68 · v30: NS_NE 69(수와식 중2, 27계열, A2 첫 규모 부여)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v30.json'),
