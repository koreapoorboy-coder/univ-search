...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v24.json (공통 15 C-* + 단원팩 D-*: EL_AELF·PS·GE·CA2_M2D·MM_CMM·PF_M1S1·EI_CMEI·SQ_ASQ·TF_ATF·GE2_CM2GE·CA1_M1D·SP_CM2SP·LF_FN·BF_BG·IN1_M1I·IN2_M2I·FG_CM2FG·CR_CP·SM_GS·TB_TR·QD_QF·EX_LE·SE_EQ)  v22: D-FN-16 수정 · v23: EX_LE 91 · v24: SE_EQ 65
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v24.json'),
