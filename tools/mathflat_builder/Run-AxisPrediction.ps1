...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v25.json (공통 15 C-* + 단원팩 D-*: …·QD_QF·EX_LE·SE_EQ·QD_QE)  v22: D-FN-16 · v23: EX_LE 91 · v24: SE_EQ 65 + 이름단독 팩D-만 · v25: QD_QE 64
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v25.json'),
