...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v32.json (공통 15 C-* + 단원팩 D-*: …·NS_NE·TQ_GP·PR_PB)  v30: NS_NE 69 · v31: TQ_GP 71(도형의 성질 중2, B1·C3 팩주도) · v32: PR_PB 68(확률 중2, B3·C3·D2 지배축 셋, E2 첫 사용)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v32.json'),
