...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v39.json (공통 15 C-* + 단원팩 D-*: …·PN_M2SL·PN_M1LC)  v36: PN_PM 48(다항식 중3) · v37: PN_IR 33(정수와 유리수 중1) · v38: PN_M2SL 30(수열의 극한 고3 미적분2 H3CA2, 균등 최평탄 D1 32.8, 평균축 2.36 B안) · v39: PN_M1LC 29(함수의 극한과 연속 고2 미적분1 H2CA1, 팩 단독 B1 50.7%, 평균축 2.30 B안)
