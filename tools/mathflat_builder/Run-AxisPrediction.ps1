...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v36.json (공통 15 C-* + 단원팩 D-*: …·PN_CMP·PN_PM)  v33: SD_ST 54 · v34: C-06 surgical `평행→평행(?!사변형)`(§3 예외) · v35: PN_CMP 55(다항식 고1) · v36: PN_PM 48(다항식 중3 M3S1, 균등 D2 49.3, D-PM-48 도형이름꼬리 분리)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v36.json'),
