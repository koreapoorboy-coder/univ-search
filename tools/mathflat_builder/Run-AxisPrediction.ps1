...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v35.json (공통 15 C-* + 단원팩 D-*: …·SD_ST·PN_CMP)  v33: SD_ST 54 · v34: C-06 surgical `평행→평행(?!사변형)`(§3 예외) · v35: PN_CMP 55(다항식 고1, 균등, A2 56건 고1 첫 규모, D1 51건 팩단독)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v35.json'),
