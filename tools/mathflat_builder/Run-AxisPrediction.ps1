...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v31.json (공통 15 C-* + 단원팩 D-*: …·SR_RC·NS_NE·TQ_GP)  v29: SR_RC 68 · v30: NS_NE 69(수와식 중2, 27계열) · v31: TQ_GP 71(도형의 성질 중2, B1·C3 팩주도, A2 15.2%)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v31.json'),
