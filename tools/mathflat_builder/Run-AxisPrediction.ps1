...
#
# v5 로 맞춘 것:
#   - 규칙 = axis_rules.v29.json (공통 15 C-* + 단원팩 D-*: …·LI_IN·SR_RC)  v28: C-06·C-10 공통 오탐 수정 · v29: SR_RC 68(실수와그계산, 26계열, 첫 남은-15단원 팩)
...
param(
  [string]$RulesPath = (Join-Path $PSScriptRoot '..\axis_prediction\axis_rules.v29.json'),
