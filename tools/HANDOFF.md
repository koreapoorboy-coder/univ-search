...
- `axis_rules.v9.json`: 규칙 264개(공통 15 + 단원팩 249: …·TF_ATF 32·GE2_CM2GE 41·CA1_M1D 24). CA2_M2D 는 M2D+M1D 공용.
  v1~v8 은 기록용 보관(v5는 검수 채팅 내부번호). 스크립트는 v9 를 읽음. **커밋됨.**
...
- **대기**: 다음 팩 CM2SP(230)→규칙 v10. 그다음 FN 216·BG 193·M2I 181(M1I와 묶어 커버율 선측정). PSS/PSC 세분화, 공통 60% 상한 열림.
