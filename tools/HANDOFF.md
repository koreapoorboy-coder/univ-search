...
- `axis_rules.v17.json`: 규칙 507개(공통 15 + 단원팩 492: …·IN1_M1I 35·IN2_M2I 19·FG_CM2FG 60). IN1_M1I 는 M1I+M2I 공용, CA2_M2D 는 M2D+M1D 공용.
  v1~v16 은 기록용 보관(v5는 검수 채팅 내부번호). 스크립트는 v17 을 읽음. **커밋됨.**
...
- **대기**: 다음 팩 pack_gap 순 잔여(CP·GS·LE·QF 등 중등, 재사용후보 BF_BG·LF_FN). PSS/PSC 세분화, 공통 60% 상한 열림.
