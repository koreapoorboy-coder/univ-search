...
- `axis_rules.v8.json`: 규칙 240개(공통 15 C-* + 단원팩 225 D-*: …·EI_CMEI 38·SQ_ASQ 30·TF_ATF 32·GE2_CM2GE 41).
  v1~v7 은 기록용 보관(v5는 검수 채팅 내부번호). 스크립트는 v8 을 읽음. **커밋됨.**
...
- **대기**: 다음 팩 M1D(231)→규칙 v9. 그다음 CM2SP 230·FN 216·BG 193·M2I 181. PSS/PSC 세분화, 공통 60% 상한 열림.
