...
- `axis_rules.v11.json`: 규칙 345개(공통 15 + 단원팩 330: …·SP_CM2SP 35·LF_FN 46). CA2_M2D 는 M2D+M1D 공용.
  v1~v10 은 기록용 보관(v5는 검수 채팅 내부번호). 스크립트는 v11 을 읽음. **커밋됨.**
...
- **대기**: 다음 팩 BG(193, 기본도형과작도 중1)·M2I 181(M1I 묶기). PSS/PSC 세분화, 공통 60% 상한 열림.
