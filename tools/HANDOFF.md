...
- `axis_rules.v13.json`: 규칙 393개(공통 15 + 단원팩 378: …·LF_FN 46·BF_BG 46). SP_CM2SP 37, CA2_M2D 는 M2D+M1D 공용.
  v1~v12 는 기록용 보관(v5는 검수 채팅 내부번호). 스크립트는 v13 을 읽음. **커밋됨.**
...
- **대기**: 다음 팩 M2I 181 + M1I 한 라운드(적분 재사용 판정 — 커버율 아니라 why). PSS/PSC 세분화, 공통 60% 상한 열림.
