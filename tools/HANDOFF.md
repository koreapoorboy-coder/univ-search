...
- `axis_rules.v6.json`: 규칙 167개(공통 15 C-* + 단원팩 152 D-*: EL_AELF 9·PS 10·GE 11·CA2_M2D 23·MM_CMM 15·PF_M1S1 16·EI_CMEI 38·SQ_ASQ 30).
  v1~v4 는 기록용 보관(v5는 검수 채팅 내부번호). 스크립트는 v6 을 읽음. **커밋됨.**
...
- **완료(v6)**: EI_CMEI 38 + SQ_ASQ 30(채팅 본문 패치로 반영). CMEI 540/적중539/팩87%/gap13%, ASQ 459/적중452/팩86%/gap13% — 예측 일치, 과다규칙 없음.
  불변식 유지(AELF·CMM·PF_M1S1). 전체 미매칭 1864→1722·pack_gap 6011→5292. 팩 보유 13/46 unit-row.
- **대기**: 다음 팩 ATF(326, 삼각함수)→규칙 v7. 그다음 CM2GE 276·M1D 231. PSS/PSC 세분화, 공통 60% 상한 판단 열림.
